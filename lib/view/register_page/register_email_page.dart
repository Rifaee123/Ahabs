                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            emailcontroller.text.isEmpty
                                ? controller.registerEmailemailvalidate.value =
                                    true
                                : controller.registerEmailemailvalidate.value =
                                    false;
                            namecontroller.text.isEmpty
                                ? controller.registerEmailnamevalidate.value =
                                    true
                                : controller.registerEmailnamevalidate.value =
                                    false;
                            passwordcontroller.text.isEmpty
                                ? controller
                                    .registerEmailpasswordvalidate.value = true
                                : controller.registerEmailpasswordvalidate
                                    .value = false;
                            ...
                            controller.dob.value == 'YYYY MM DD'
                                ? controller.registerEmaildobvalidate.value =
                                    true
                                : controller.registerEmaildobvalidate.value =
                                    false;
                            ...
                            if (result.isVerified == true) {
                              if (passwordcontroller.text !=
                                ...
                                if (namecontroller.text.isNotEmpty ||
                                  ...
                                  Provider.of<EmailRegistrationProvider>(
                                          context,
                                          listen: false)
                                      .registerWithEmail(
                                          gender: gender,
