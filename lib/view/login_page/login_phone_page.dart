                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              loginphonepasscontroller.text.isEmpty
                                  ? controller
                                      .loginphonepasswordvalidate.value = true
                                  : controller
                                      .loginphonepasswordvalidate.value = false;
                              if (loginphonecontroller.text.isNotEmpty &&
                                ...
                                print(logintoken);
                                final result = Provider.of<LoginProvider>(
                                        context,
                                        listen: false)
                                    .resultData;
                                if (result.isAuthorized == true) {
                                  ...
                                  authcontrolller.registerCurrentIndex.value =
                                      0;
